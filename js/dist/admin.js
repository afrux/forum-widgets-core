...
/* harmony import */ var _common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../common/utils/sortWidgets */ "./src/common/utils/sortWidgets.ts");
...
var WidgetEditor = /*#__PURE__*/function (_ExtensionPage) {
  ...
  _proto.content = function content() {
    var settings = app.extensionData.getSettings(this.extension.id);
    return m("div", {
  ...
  _proto.editor = function editor() {
    ...
    return m("div", {
    ...
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_5__["default"])(app.widgets.get('top', true)).map(function (widget, index) {
      ...
      className: "Afrux-ForumWidgets-layout-section-items"
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_5__["default"])(app.widgets.get('start_top', true)).map(function (widget, index) {
      return _this2.layoutWidget(widget, index);
    }))), m("div", {
      ...
      className: "Afrux-ForumWidgets-layout-section-items"
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_5__["default"])(app.widgets.get('start_bottom', true)).map(function (widget, index) {
      return _this2.layoutWidget(widget, index);
    })))), m("div", {
      ...
      "data-section": "end",
      className: "Afrux-ForumWidgets-layout-section-items"
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_5__["default"])(app.widgets.get('end', true)).map(function (widget, index) {
      return _this2.layoutWidget(widget, index);
    })))), m("div", {
      ...
      "data-section": "bottom",
      className: "Afrux-ForumWidgets-layout-section-items"
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_5__["default"])(app.widgets.get('bottom', true)).map(function (widget, index) {
      return _this2.layoutWidget(widget, index);
    }))))), m("div", {
    ...
    }, app.widgets.widgets.filter(function (widget) {
      return app.data.extensions[widget.extension];
  ...
  _proto.createEditorSections = function createEditorSections() {
    ...
    this.$('.Afrux-ForumWidgets-layout-section-items, .Afrux-ForumWidgets-widgets-store').get().map(function (e) {
      ...
      sortablejs__WEBPACK_IMPORTED_MODULE_2__["default"].create(e, {
        group: {
          name: section,
          pull: function pull() {
  ...
  _proto.widget = function widget(_widget, placed) {
    ...
    var extension = app.data.extensions[_widget.extension];
    return m("div", {
    ...
    }, extension.icon ? flarum_common_helpers_icon__WEBPACK_IMPORTED_MODULE_4___default()(extension.icon.name) : ''), m("span", {
