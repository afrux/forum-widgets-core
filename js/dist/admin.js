...
/***/ "./src/admin/components/WidgetEditor.tsx":
/*!***********************************************!*\
  !*** ./src/admin/components/WidgetEditor.tsx ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return WidgetEditor; });
...
/* harmony import */ var _common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../common/utils/sortWidgets */ "./src/common/utils/sortWidgets.ts");
...
var WidgetEditor = /*#__PURE__*/function (_ExtensionPage) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__["default"])(WidgetEditor, _ExtensionPage);
  ...
  function WidgetEditor() {
    ...
    _this.config = void 0;
    _this.placeholderCache = {};
    return _this;
  }

  var _proto = WidgetEditor.prototype;

  _proto.oninit = function oninit(vnode) {
    _ExtensionPage.prototype.oninit.call(this, vnode);

    this.config = this.getConfig();
    flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.widgets.setConfig(this.config);
  };

  _proto.onupdate = function onupdate(vnode) {
    _ExtensionPage.prototype.onupdate.call(this, vnode);

    this.cleanupLayout();
  };

  _proto.content = function content(vnode) {
    var settings = flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.extensionData.getSettings(this.extension.id);
    return m("div", {
      className: "ExtensionPage-settings"
    }, m("div", {
      className: "container"
    }, !flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.data['afrux-forum-widgets-core.cache_store_writable'] ? m(flarum_common_components_Alert__WEBPACK_IMPORTED_MODULE_7___default.a, {
      type: "error",
      dismissible: false
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('afrux-forum-widgets-core.admin.cache_not_writable_warning')) : null, m("div", {
      className: "Form"
    }, m("div", {
      className: "Form-group"
    }, this.editor()), settings ? settings.map(this.buildSettingComponent.bind(this)) : null, m("div", {
      className: "Form-group"
  ...
  _proto.editor = function editor() {
    ...
    return m("div", {
      className: "Afrux-ForumWidgets-editor",
      oncreate: this.createEditorSections.bind(this)
    }, m("div", {
      className: "Afrux-ForumWidgets-layout"
    }, m("div", {
      className: "Afrux-ForumWidgets-layout-header Afrux-ForumWidgets-layout-concrete"
    }, m("div", {
      className: "Afrux-ForumWidgets-layout-container Afrux-ForumWidgets-layout-headerWrapper"
    }, m("div", {
      className: "Afrux-ForumWidgets-layout-placeholder Afrux-ForumWidgets-layout-placeholder--header"
    }), m("div", {
      className: "Afrux-ForumWidgets-layout-placeholderGroup"
    }, m("div", {
      className: "Afrux-ForumWidgets-layout-placeholder Afrux-ForumWidgets-layout-placeholder--icon"
    }), m("div", {
      className: "Afrux-ForumWidgets-layout-placeholder Afrux-ForumWidgets-layout-placeholder--icon"
    })))), m("div", {
      className: "Afrux-ForumWidgets-layout-hero Afrux-ForumWidgets-layout-concrete"
    }, m("div", {
      className: "Afrux-ForumWidgets-layout-placeholder Afrux-ForumWidgets-layout-placeholder--header"
    }), m("div", {
      className: "Afrux-ForumWidgets-layout-placeholder"
    }), m("div", {
      className: "Afrux-ForumWidgets-layout-placeholder Afrux-ForumWidgets-layout-placeholder--long"
    })), m("div", {
      className: "Afrux-ForumWidgets-layout-contentWrapper Afrux-ForumWidgets-layout-container"
    }, m("div", {
      className: "Afrux-ForumWidgets-layout-topSection Afrux-ForumWidgets-layout-section"
    }, m("ol", {
      "data-section": "top",
      className: "Afrux-ForumWidgets-layout-section-items"
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_6__["default"])(flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.widgets.get('top', true)).map(function (widget, index) {
      return _this2.layoutWidget(widget, index);
    }))), m("div", {
      className: "Afrux-ForumWidgets-layout-sideNavContainer"
    }, m("div", {
      className: "Afrux-ForumWidgets-layout-sideNavWrapper"
    }, m("div", {
      className: "Afrux-ForumWidgets-layout-startTopSection Afrux-ForumWidgets-layout-section"
    }, m("ol", {
      "data-section": "start_top",
      className: "Afrux-ForumWidgets-layout-section-items"
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_6__["default"])(flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.widgets.get('start_top', true)).map(function (widget, index) {
      return _this2.layoutWidget(widget, index);
    }))), m("div", {
      className: "Afrux-ForumWidgets-layout-sideNav Afrux-ForumWidgets-layout-concrete"
    }, m("div", {
      className: "Afrux-ForumWidgets-layout-placeholder Afrux-ForumWidgets-layout-placeholder--button"
    }, m("div", {
      className: "Afrux-ForumWidgets-layout-placeholder"
    })), this.makePlaceholders('sidenav', 8, 20, 80).map(function (placeholder) {
      return m("div", {
        className: "Afrux-ForumWidgets-layout-placeholderGroup"
      }, m("div", {
        className: "Afrux-ForumWidgets-layout-placeholder Afrux-ForumWidgets-layout-placeholder--icon"
      ...
      className: "Afrux-ForumWidgets-layout-startBottomSection Afrux-ForumWidgets-layout-section"
    }, m("ol", {
      "data-section": "start_bottom",
      className: "Afrux-ForumWidgets-layout-section-items"
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_6__["default"])(flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.widgets.get('start_bottom', true)).map(function (widget, index) {
      return _this2.layoutWidget(widget, index);
    })))), m("div", {
      className: "Afrux-ForumWidgets-layout-sideNavOffset Afrux-ForumWidgets-layout-concrete"
    }, this.makePlaceholders('sideNavOffset', 6, 20, 80).map(function (placeholder) {
      return m("div", {
        className: "Afrux-ForumWidgets-layout-placeholderGroup"
      }, m("div", {
        className: "Afrux-ForumWidgets-layout-placeholder Afrux-ForumWidgets-layout-placeholder--icon"
      }), m("div", {
        className: "Afrux-ForumWidgets-layout-placeholderGroup-content"
      }, placeholder, _this2.makePlaceholders('discussion', 1, 20, 50)));
    })), m("div", {
      className: "Afrux-ForumWidgets-layout-sideNavAlt Afrux-ForumWidgets-layout-section"
    }, m("ol", {
      "data-section": "end",
      className: "Afrux-ForumWidgets-layout-section-items"
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_6__["default"])(flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.widgets.get('end', true)).map(function (widget, index) {
      return _this2.layoutWidget(widget, index);
    })))), m("div", {
      className: "Afrux-ForumWidgets-layout-bottomSection Afrux-ForumWidgets-layout-section"
    }, m("ol", {
      "data-section": "bottom",
      className: "Afrux-ForumWidgets-layout-section-items"
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_6__["default"])(flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.widgets.get('bottom', true)).map(function (widget, index) {
      return _this2.layoutWidget(widget, index);
    }))))), m("div", {
      className: "Afrux-ForumWidgets-widgets"
    }, m("ol", {
      "data-section": "store",
      className: "Afrux-ForumWidgets-widgets-store"
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.widgets.widgets.filter(function (widget) {
      return flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.data.extensions[widget.extension];
    }).map(function (widget, index) {
      var attrs = {};

      var available = _this2.isWidgetAvailable(widget);
  ...
  _proto.createEditorSections = function createEditorSections() {
    var _this3 = this;

    this.cleanupLayout();
    this.$('.Afrux-ForumWidgets-layout-section-items, .Afrux-ForumWidgets-widgets-store').get().map(function (e) {
      var section = $(e).data('section');
      sortablejs__WEBPACK_IMPORTED_MODULE_3__["default"].create(e, {
        group: {
          name: section,
          pull: function pull() {
        ...
        onSort: _this3.onSortUpdate.bind(_this3),
        onClone: function onClone(e) {
          $(e.clone).attr('disabled', true);
        },
        onAdd: function onAdd(e) {
          if (section === 'store') {
            var _e$item$parentNode;

            _this3.setConfig(Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, _this3.config, {
              disabled: [].concat(_this3.config.disabled || [], [e.item.dataset.id])
            }));

            (_e$item$parentNode = e.item.parentNode) == null ? void 0 : _e$item$parentNode.removeChild(e.item);

            _this3.$(".Afrux-ForumWidgets-widgets-store li[data-id=\"" + e.item.dataset.id + "\"]").attr('disabled', false);
          }
        },
        onRemove: function onRemove(e) {
          if (section === 'store') {
            _this3.setConfig(Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, _this3.config, {
              disabled: (_this3.config.disabled || []).filter(function (wid) {
                return wid !== e.item.dataset.id;
              })
            }));
          }
        }
  ...
  _proto.cleanupLayout = function cleanupLayout() {
    var _this4 = this;

    this.$('.Afrux-ForumWidgets-layout-section-items').get().map(function (element) {
      var section = element.dataset.section;

      _this4.$(".Afrux-ForumWidgets-layout-section-items[data-section=\"" + section + "\"] li:not([data-section=\"" + section + "\"])").remove();
    });
  };

  _proto.widget = function widget(_widget, placed) {
    if (placed === void 0) {
      placed = false;
    }

    var extension = flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.data.extensions[_widget.extension];
    return m("div", {
      className: "Afrux-ForumWidgets-Widget-container"
    }, m("div", {
      className: "Afrux-ForumWidgets-Widget"
    }, m("span", {
      className: "Afrux-ForumWidgets-Widget-icon ExtensionIcon",
      style: extension.icon
    }, extension.icon ? flarum_common_helpers_icon__WEBPACK_IMPORTED_MODULE_5___default()(extension.icon.name) : ''), m("span", {
      className: "Afrux-ForumWidgets-Widget-title"
    }, extension.extra['flarum-extension'].title)));
  };

  _proto.layoutWidget = function layoutWidget(widget) {
    return m("li", {
  ...
  _proto.onSortUpdate = function onSortUpdate() {
    var instances = [];
    this.$('.Afrux-ForumWidgets-layout-section-items').get().map(function (sectionElement) {
      var section = sectionElement.dataset.section;
      Array.from(sectionElement.children).map(function (widgetElement, i) {
        instances.push({
    ...
    this.setConfig(Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, this.config, {
      instances: instances
    }));
  };

  _proto.isWidgetAvailable = function isWidgetAvailable(widget) {
    var disabled = this.config.disabled || [];
    return disabled.includes(widget.id) && widget.isUnique;
  };

  _proto.makePlaceholders = function makePlaceholders(key, count, minWidth, maxWidth) {
    if (count === void 0) {
      count = 1;
    }

    if (this.placeholderCache[key]) return this.placeholderCache[key];
    return this.placeholderCache[key] = Array(count).fill(null).map(function () {
      return m("div", {
        className: "Afrux-ForumWidgets-layout-placeholder",
  ...
  _proto.setConfig = function setConfig(config) {
    this.config = config;
    flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.widgets.setConfig(config);
...
WidgetEditor.settingKey = 'afrux-forum-widgets-core.config';
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _common_WidgetManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/WidgetManager */ "./src/common/WidgetManager.ts");
/* harmony import */ var _components_WidgetEditor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/WidgetEditor */ "./src/admin/components/WidgetEditor.tsx");
/* harmony import */ var _compat__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./compat */ "./src/admin/compat.ts");
/* harmony import */ var _flarum_core_admin__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @flarum/core/admin */ "@flarum/core/admin");
/* harmony import */ var _flarum_core_admin__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_flarum_core_admin__WEBPACK_IMPORTED_MODULE_3__);


app.widgets = new _common_WidgetManager__WEBPACK_IMPORTED_MODULE_0__["default"]();
app.initializers.add('afrux/forum-widgets-core', function () {
  app.extensionData["for"]('afrux-forum-widgets-core').registerSetting({
    ...
    type: 'boolean'
  }).registerPage(_components_WidgetEditor__WEBPACK_IMPORTED_MODULE_1__["default"]);
}); // Expose compat API

 // @ts-ignore


Object.assign(_flarum_core_admin__WEBPACK_IMPORTED_MODULE_3__["compat"], _compat__WEBPACK_IMPORTED_MODULE_2__["default"]);
