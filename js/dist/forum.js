...
/* harmony import */ var _components_EndWidgetSection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/EndWidgetSection */ "./src/forum/components/EndWidgetSection.js");
/* harmony import */ var _components_StartTopWidgetSection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/StartTopWidgetSection */ "./src/forum/components/StartTopWidgetSection.js");
/* harmony import */ var _components_StartBottomWidgetSection__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/StartBottomWidgetSection */ "./src/forum/components/StartBottomWidgetSection.js");
/* harmony import */ var _components_TopWidgetSection__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/TopWidgetSection */ "./src/forum/components/TopWidgetSection.js");
...
/***/ "./src/forum/components/BottomWidgetSection.js":
/*!*****************************************************!*\
  !*** ./src/forum/components/BottomWidgetSection.js ***!
  \*****************************************************/
/*! exports provided: default */
...
/* harmony import */ var _common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../common/utils/sortWidgets */ "./src/common/utils/sortWidgets.ts");
...
var BottomWidgetSection = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_3__["default"])(app.widgets.get('bottom')).map(function (widget) {
...
/***/ "./src/forum/components/EndWidgetSection.js":
/*!**************************************************!*\
  !*** ./src/forum/components/EndWidgetSection.js ***!
  \**************************************************/
/*! exports provided: default */
...
var EndWidgetSection = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_3__["default"])(app.widgets.get('end')).map(function (widget) {
      return widget.component.component({
        state: widget.state
      });
    }));
...
/***/ "./src/forum/components/StartBottomWidgetSection.js":
/*!**********************************************************!*\
  !*** ./src/forum/components/StartBottomWidgetSection.js ***!
  \**********************************************************/
/*! exports provided: default */
...
var StartBottomWidgetSection = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_3__["default"])(app.widgets.get('start_bottom')).map(function (widget) {
      return widget.component.component({
        state: widget.state
      });
    }));
...
/***/ "./src/forum/components/StartTopWidgetSection.js":
/*!*******************************************************!*\
  !*** ./src/forum/components/StartTopWidgetSection.js ***!
  \*******************************************************/
/*! exports provided: default */
...
var StartTopWidgetSection = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_3__["default"])(app.widgets.get('start_top')).map(function (widget) {
      return widget.component.component({
        state: widget.state
      });
    }));
...
/***/ "./src/forum/components/TopWidgetSection.js":
/*!**************************************************!*\
  !*** ./src/forum/components/TopWidgetSection.js ***!
  \**************************************************/
/*! exports provided: default */
...
var TopWidgetSection = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    }, Object(_common_utils_sortWidgets__WEBPACK_IMPORTED_MODULE_3__["default"])(app.widgets.get('top')).map(function (widget) {
      return widget.component.component({
        state: widget.state
      });
    }));
...
/* harmony import */ var _common_WidgetManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../common/WidgetManager */ "./src/common/WidgetManager.tsx");
/* harmony import */ var _components_EndWidgetSection__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/EndWidgetSection */ "./src/forum/components/EndWidgetSection.js");
/* harmony import */ var _components_StartTopWidgetSection__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/StartTopWidgetSection */ "./src/forum/components/StartTopWidgetSection.js");
/* harmony import */ var _components_StartBottomWidgetSection__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/StartBottomWidgetSection */ "./src/forum/components/StartBottomWidgetSection.js");
/* harmony import */ var _components_TopWidgetSection__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/TopWidgetSection */ "./src/forum/components/TopWidgetSection.js");
/* harmony import */ var _components_BottomWidgetSection__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/BottomWidgetSection */ "./src/forum/components/BottomWidgetSection.js");
...
app.initializers.add('afrux/forum-widgets-core', function () {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'view', function (vnode) {
    vnode.children[1].children[0].children.push(m(_components_EndWidgetSection__WEBPACK_IMPORTED_MODULE_3__["default"], null));
    vnode.children[1].children = [m(_components_TopWidgetSection__WEBPACK_IMPORTED_MODULE_6__["default"], null)].concat(vnode.children[1].children, [m(_components_BottomWidgetSection__WEBPACK_IMPORTED_MODULE_10__["default"], null)]);
  });
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_forum_components_IndexPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'sidebarItems', function (items) {
